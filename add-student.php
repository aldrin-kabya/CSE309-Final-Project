				...
				<div class="row">
					<div class="col-xl-12 col-xxl-12 col-sm-12">
                        <div class="card">
							...
							<div class="card-body">
                                <form action="add-student.php" method="post" name="studentForm" onsubmit="return validateForm()">
									<div class="row">
...
<script src="vendor/global/global.min.js"></script>
	...
	<script>
		function validateForm() {
			const name = document.forms["studentForm"]["student_name"].value;
			const level = document.forms["studentForm"]["academic_level"].value;
			const id = document.forms["studentForm"]["student_id"].value;
			const email = document.forms["studentForm"]["email"].value;
			const regDate = document.forms["studentForm"]["registration_date"].value;
			const gender = document.forms["studentForm"]["gender"].value;
			const mobile = document.forms["studentForm"]["mobile_number"].value;
			const dob = document.forms["studentForm"]["date_of_birth"].value;
			const supervisor = document.forms["studentForm"]["supervisor"].value;
			const address = document.forms["studentForm"]["address_"].value;
			const major = document.forms["studentForm"]["major"].value;
			const status = document.forms["studentForm"]["student_status"].value;

			if (name === "" || level === "" || id === "" || email === "" || regDate === "" || gender === "" || mobile === "" || dob === "" || supervisor === "" || address === "" || major === "" || status === "") {
