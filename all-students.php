											...
											<table id="example3" class="display" style="min-width: 845px">
												...
												<?php
													...
													if (isset($_POST['delete'])) {
														$id = $_POST['id'];
														mysqli_query($conn, "DELETE FROM students WHERE stud_id='$id'");
													}
													...
													if (mysqli_num_rows($result) > 0) {
														...
														while ($row = mysqli_fetch_array($result)) {
															...
															echo '<td>';
															echo '<a href="edit-student.php?stud_id=' . $row['stud_id'] . '" class="btn btn-sm btn-primary"><i class="la la-pencil"></i></a>';
															echo '<form method="post">';
															echo '<input type="hidden" name="id" value="' . $row['stud_id'] . '">';
