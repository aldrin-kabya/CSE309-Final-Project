				...
				<div class="row">
					<div class="col-xl-12 col-xxl-12 col-sm-12">
                        <div class="card">
							...
							<div class="card-body">
                                <form action="apply-for-grants.php" method="post" name="grantForm" onsubmit="return validateForm()">
									<div class="row">
    ...
    ***********************************-->
    ...
    <script>
		function validateForm() {
            var projectTitle = document.forms["grantForm"]["project_title"].value;
            var principalInvestigator = document.forms["grantForm"]["principal_investigator"].value;
            var projectSummary = document.forms["grantForm"]["project_summary"].value;
            var projectDescription = document.forms["grantForm"]["project_description"].value;
            var department = document.forms["grantForm"]["department"].value;
            var timeline = document.forms["grantForm"]["timeline"].value;
            var budget = document.forms["grantForm"]["budget"].value;
            var applicationDate = document.forms["grantForm"]["application_date"].value;
            var fundingAgency = document.forms["grantForm"]["funding_agency"].value;
            var projectStatus = document.forms["grantForm"]["project_status"].value;
            var projectImpact = document.forms["grantForm"]["project_impact"].value;
            ...
            if (fundingAgency == "") {
                alert("Please select a funding agency");
                return false;
            }
            if (projectStatus == "") {
