				...
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
							...
							<div class="card-body">
								<form action="add-publications.php" method="post" name="publicationForm" onsubmit="return validateForm()">
									<div class="row">
...
<script src="vendor/global/global.min.js"></script>
	...
	<script>
		function validateForm() {
			var title = document.forms["publicationForm"]["publication_title"].value;
			var publisher = document.forms["publicationForm"]["publisher"].value;
			var authors = document.forms["publicationForm"]["authors"].value;
			var department = document.forms["publicationForm"]["department"].value;
			var submissionDate = document.forms["publicationForm"]["submission_date"].value;
			var keywords = document.forms["publicationForm"]["keywords"].value;
			var status = document.forms["publicationForm"]["publication_status"].value;
			var abstract = document.forms["publicationForm"]["abstract"].value;
			
			if (title == "" || publisher == "" || authors == "" || department == "" || submissionDate == "" || keywords == "" || status == "" || abstract == "") {
