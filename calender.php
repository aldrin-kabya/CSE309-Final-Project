            ...
            <div class="container-fluid">
				...
				<div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Calender</a></li>
                            ...
                            <div class="card-body">
                                ...
                                <div class="">
                                    <div id="external-events" class="my-3">
                                        ...
                                        <div class="external-event" data-class="bg-primary"><i class="fa fa-move"></i>Milestones</div>
                                        <div class="external-event" data-class="bg-danger"><i class="fa fa-move"></i>Meetings
                                        </div>
                                        <div class="external-event" data-class="bg-warning"><i class="fa fa-move"></i>Conferences</div>
                                        <div class="external-event" data-class="bg-dark"><i class="fa fa-move"></i>Research Events</div>
                                    </div>
                                    <!-- checkbox -->
